...
class WalletPaymentOptionsEndpoint extends RestServiceBaseEndpoint
{
     ...
     * @ApiRoute(name="/authenticated/wallet/paymentoptions")
    ...
    {
        echo "return list of strings payment options";
        // TODO delegate the call to paywith.glass and return the output
    }
    
}

$endpoint = new WalletPaymentOptionsEndpoint();
